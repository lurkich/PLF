...
$list_specs_xml = $level_1_xml->spec;

$p_cnt = count($list_specs_xml->spec);

foreach ($list_specs_xml->spec as $xx) {

    $p_cnt = count($list_specs_xml);
    echo("count : " . $p_cnt . "\n");
    echo("  " . $xx->attributes() . "\n");

    foreach($xx->spec as $yy) {
...
//$list_specs = simplexmlToArray($list_specs_xml);
