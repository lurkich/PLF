...
class SPW_Chasses_Fermeture_OK_Gateway
{


    private PDO $conn;
    private int $duplicate_records;

    public function __construct(Database $database)
    {
        $this->conn = $database->getConnection();
        $GLOBALS["duplicate_records"] = 0;
    ...
    public function New_Territoire(array $data) {
        ...
        try {
            ...
            $stmt->execute();
            $GLOBALS["total_Territoires_Records"]++;
...
// 
        ...
        try {
            ...
            switch ($SQL_Error) {
                case 1062:
                     $GLOBALS["duplicate_Territoires_Records"]++;
                    break;
                default:
