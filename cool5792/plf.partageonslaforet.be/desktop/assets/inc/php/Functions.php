...
class PLF
{
    ...
    public static function SPW_Get_Territoire_List(string $Saison = null): array | false
    {
        ...
        $sql_cmd = "SELECT DISTINCT SAISON, N_LOT 
    ...
    public static function SPW_Get_Territoire_Info(string $Territoire_Name, string $Saison = null): array | false
    {
    ...
    public static function SPW_Get_Chasse_By_Date(string $Chasse_Date, string $Saison = null): array | false
    {
    ...
    public static function SPW_Get_Chasse_By_Territoire(string $Territoire_Name, string $Saison = null): array | false
    {
    ...
    public static function SPW_Get_Territoire_By_Canton(string $Num_Canton, string $Saison = null): array | false
    {
    ...
    public static function SPW_Territoire_JSON(string $Territoire_Name, string $Saison = null) : array | false
    {
     ...
     *-------------------------------------------------------------------------------------------------------------------------------------------*/
     ...
     public static function SPW_Get_Territoire_By_CC(string $Code_CC, string $Saison = null) : array | false
     {
